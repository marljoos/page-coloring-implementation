...
def main():
    ...
    all_executors = {name: executor for (name, executor) in all_memory_consumers.items()\
                     if isinstance(executor, Executor)}

    logging.info("Color assignment (with security clearance method):")
    ColorAssigner.assign_color_by_security_labels(hardware, all_executors)
